...
export const NeonCard = ({ title, value, icon: Icon, subLabel, subValue, accent, shadow }: NeonCardProps) => (
  ...
  >
    <div className="h-full w-full bg-[#0a0a0a] rounded-2xl p-5 transition-transform duration-200 group-hover:scale-[0.98] flex flex-col justify-between border border-white/5 z-10 relative">
